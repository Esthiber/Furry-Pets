...
namespace PawfectMatch.Migrations
{
    ...
    [Migration("20250711141228_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawfectMatch.Models.CategoriasProductos", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.DetallesFacturas", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.EstadoMascota", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.EstadosPagos", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.Facturas", b =>
                {
                    b.Property<int>("FacturasID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawfectMatch.Models.HistorialAdopciones", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.MascotasAdopcion", b =>
                {
                    b.Property<int>("MascotasAdopcionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawfectMatch.Models.Pagos", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.Productos", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.Servicios", b =>
                {
            ...
            modelBuilder.Entity("PawfectMatch.Models.TiposItems", b =>
                {
                    b.Property<int>("TiposItemsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawfectMatch.Models.TiposServicios", b =>
                {
                    b.Property<int>("TiposServiciosID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawfectMatch.Models.Citas", b =>
                {
                    ...
                    b.HasOne("PawfectMatch.Models.MascotasPersonas", "MascotaPersona")
                        .WithMany()
            ...
            modelBuilder.Entity("PawfectMatch.Models.DetallesFacturas", b =>
                {
                    b.HasOne("PawfectMatch.Models.Facturas", "Factura")
                        .WithMany("Detalles")
                        .HasForeignKey("FacturasID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PawfectMatch.Models.TiposItems", "TipoItem")
            ...
            modelBuilder.Entity("PawfectMatch.Models.Facturas", b =>
                {
                    b.HasOne("PawfectMatch.Models.EstadosPagos", "EstadoPago")
                        .WithMany("Facturas")
            ...
            modelBuilder.Entity("PawfectMatch.Models.Productos", b =>
                {
                    b.HasOne("PawfectMatch.Models.CategoriasProductos", "CategoriaProducto")
                        .WithMany()
            ...
            modelBuilder.Entity("PawfectMatch.Models.SeguimientoMascotas", b =>
                {
                    b.HasOne("PawfectMatch.Models.EstadoMascota", "EstadoMascota")
            ...
            modelBuilder.Entity("PawfectMatch.Models.Servicios", b =>
                {
                    b.HasOne("PawfectMatch.Models.TiposServicios", "TipoServicio")
                        .WithMany()
